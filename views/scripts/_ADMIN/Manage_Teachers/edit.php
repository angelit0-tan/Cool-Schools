...
function upload_completed(){
	...
	$('.content-body').load('index.php?__admin/m_index');
	/*
...
<form method="post" id="newupload" action="index.php?__admin/m_update" enctype="multipart/form-data" target="hidden_upload" onsubmit="upload_started()">
	<div id='m_content' style='float: left;'>
		...
		<tr>
			...
			<td align='left'>
				<input type='text' id='lname' name='lname' style='width: 160px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;' value="<?php echo $data['info'][0]['lastname']; ?>">
		...
		<tr>
			...
			<td align='left'>
				<input type='text' id='fname' name='fname' style='width: 200px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;' value="<?php echo $data['info'][0]['firstname']; ?>">
		...
		<tr>
			...
			<td align='left'>
				<input type='text' id='mname' name='mname' style='width: 200px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;' value="<?php echo $data['info'][0]['middlename']; ?>">
		...
		<tr>
			...
			<td align='left'>
				<input type='text' id='bday' name='bday' style='width: 160px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 12px;' class='demo' value="<?php echo date('m/d/Y', strtotime($data['info'][0]['birthday'])); ?>">
		...
		<tr>
			...
			<td align='left'>
				<input type='text' id='contact' name='contact' style='width: 160px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;' value="<?php echo $data['info'][0]['contact']; ?>">
			</td>
		</tr>
		<tr>
			<td align='right'>
			...
			<td>
				...
				<select id='status' name='status' style='font-size: 11px;'>
					...
					?>
						<option <?php echo ( $row['status_id']==$data['info'][0]['status_id'] ? 'selected' : '') ;?> value="<?php echo $row['status_id'];?>"> <?php echo $row['status']; ?> </option>
					<?php
					}
					?>
				</select>
	...
	<table style='font-family: tahoma; font-size: 11px;'>
		<tr>
			...
			<td align='left'>
				<input type='text' id='username' name='username' style='width: 120px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;' value="<?php echo $data['info'][0]['user_name']; ?>">
		...
		<tr>
			...
			<td align='left'>
				<input type='password' id='password' name='password' style='width: 160px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;' value="<?php echo $data['info'][0]['user_pass']; ?>">
		...
		<tr>
			...
			<td align='left'>
				<input type='password' id='cpassword' name='cpassword' style='width: 160px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;' value="<?php echo $data['info'][0]['user_pass']; ?>">
	...
	<input type='hidden' id='user_id' name='user_id' value="<?php echo $data['info'][0]['user_id']; ?>">
</form>
