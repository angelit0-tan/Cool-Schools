...
<div style='width: 630px; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(238, 238, 238);'> 
	...
	<tr>
		<td style='align: center; valign: middle; width: 9%'> 
			<img src = <?php echo '/' . BASE_DIR  . '/public/images/icons/knowledge_base/question_b.png'; ?>  style='height: 35px; width: 35px;'>
		</td>
		<td align='left' valign='middle' style='font-family: tahoma; font-size: 16px; text-decoration: none;'>
						<a href="javascript:getpage('index.php?knowledgeshare/view&sharetype=question&id=<?php echo $row['knowledge_id']; ?>');"> <b> <?php echo $row['fld_subject']; ?> </b> </a>
