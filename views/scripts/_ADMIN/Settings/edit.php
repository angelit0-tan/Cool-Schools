...
$(document).ready(function(){
	$('#miscsave').click(function(){
		...
		*/
		...
		if ( error == 0 ){
			$.post('index.php?__admin/update_misc',
				{
					year: $('#year').val(), misc_name: $('#miscname').val(), misc_percent: $('#misc_percent').val(), 
					misc_amount: $('#misc_amount').val(), misc_id: $('#misc_id').val()
				},function(data){
	...
	$("input[name='rate']").bind('change',function(){
		...
		if ( $(this).is(':checked') ){
			if( $(this).val() == 'misc_percent' ){
				...
				$('#misc_amount').attr('disabled',true).val('');
				$('#chk_amount').attr('checked', false);
			}else{
				$('#'+ $(this).val()).attr('disabled', false);
				$('#misc_percent').attr('disabled',true).val('');
...
<tr>
	...
	<td>
		...
		<input type='text' style='font-family: tahoma; font-size: 11px;' id='miscname' value="<?php echo $data[0]['misc_name']; ?>">
	</td>
</tr>
<tr>
	<td align='right'>
	...
	<td>
		...
		<input type='text' id='misc_percent' disabled style='font-family: tahoma; font-size: 11px;' value="<?php echo $data[0]['misc_percent_rate']; ?>"> 
...
<tr>
	...
	<td>
		...
		<input type='text' id='misc_amount' disabled style='font-family: tahoma; font-size: 11px;' value="<?php echo $data[0]['misc_amount_rate']; ?>">
...
<tr>
	...
	<td>
		...
		<input type='text' id='year' style='font-family: tahoma; font-size: 11px;' value="<?php echo $data[0]['validated_year']; ?>">
	</td>
</tr>
</table>
...
<input type='hidden' id='misc_id' value="<?php echo $data[0]['misc_id']; ?>">
</div>