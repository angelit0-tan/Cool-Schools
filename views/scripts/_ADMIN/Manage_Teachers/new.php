...
function upload_completed(){
	...
	$('.content-body').load('index.php?__admin/m_teachers');
}
...
<form method="post" id="newupload" action="index.php?__admin/m_save" enctype="multipart/form-data" target="hidden_upload" onsubmit="upload_started()">
	<div id='m_content' style='float: left;'>
		...
		<tr>
			...
			<td align='left'>
				<input type='text' id='lname' name='lname' style='width: 160px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;'>
		...
		<tr>
			...
			<td align='left'>
				<input type='text' id='fname' name='fname' style='width: 200px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;'>
		...
		<tr>
			...
			<td align='left'>
				<input type='text' id='mname' name='mname' style='width: 200px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;'>
		...
		<tr>
			...
			<td align='left'>
				<input type='text' id='bday' name='bday' style='width: 160px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 12px;' class='demo'>
		...
		<tr>
			...
			<td align='left'>
				<input type='text' id='contact' name='contact' style='width: 160px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;'>
			</td>
		</tr>
		<tr>
			<td align='right'>
			...
			<td>
				...
				<select id='status' name='status' style='font-size: 11px;'>
					<option value='' selected='selected'><b>Select a status</b>
					</option>
					<?php
					foreach ( $data as $row ){
					?>
	...
	<table style='font-family: tahoma; font-size: 11px;'>
		<tr>
			...
			<td align='left'>
				<input type='text' id='username' name='username' style='width: 120px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;'>
		...
		<tr>
			...
			<td align='left'>
				<input type='password' id='password' name='password' style='width: 160px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;'>
		...
		<tr>
			...
			<td align='left'>
				<input type='password' id='cpassword' name='cpassword' style='width: 160px; height: 19px; font-size: 12px; margin-left: 4px; font-size: 11px;'>
